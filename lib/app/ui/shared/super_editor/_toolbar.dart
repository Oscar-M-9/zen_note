...
import 'package:my_notes/app/ui/shared/super_editor/infrastructure/super_editor_item_selector.dart';
            ...
            children: [
              ...
              Center(
                child: IconButton(
                  ...
                  splashRadius: 16,
                  tooltip: S.of(context).labelSuperscript,
                ),
              ),
              Center(
                child: IconButton(
                  ...
                  splashRadius: 16,
                  tooltip: S.of(context).labelSubscript,
                ),
              ),
              Center(
                child: IconButton(
            ...
            children: [
              Center(
                child: IconButton(
                  ...
                  splashRadius: 16,
                  tooltip: S.of(context).labelLimitedWidth,
                ),
              ),
              Center(
                child: IconButton(
                  ...
                  splashRadius: 16,
                  tooltip: S.of(context).labelFullWidth,
                ),
              ),
            ],
          ),
